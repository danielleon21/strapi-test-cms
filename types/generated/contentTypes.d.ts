...
export interface ApiDogDog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    size: Attribute.Relation<'api::dog.dog', 'manyToOne', 'api::size.size'>;
    shelter: Attribute.Relation<
      'api::dog.dog',
      'manyToOne',
      'api::shelter.shelter'
    >;
...
export interface ApiShelterShelter extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    direction: Attribute.Text & Attribute.Required;
...
export interface ApiSizeSize extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    dogs: Attribute.Relation<'api::size.size', 'oneToMany', 'api::dog.dog'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::shelter.shelter': ApiShelterShelter;
